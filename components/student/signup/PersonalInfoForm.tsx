      ...
      <CardContent className="space-y-6 pb-8">
        <div className="grid gap-5">
          <div className="space-y-2">
            <Label htmlFor="fullname" className="text-sm font-medium text-slate-700 dark:text-slate-100">
              Full Name
            </Label>
            <Input
              id="fullname"
          ...
          <div className="space-y-2">
            <Label htmlFor="matricNumber" className="text-sm font-medium text-slate-700 dark:text-slate-100">
              Matric Number
            </Label>
            <Input
              id="matricNumber"
          ...
          <div className="space-y-2">
            <Label htmlFor="phoneNumber" className="text-sm font-medium text-slate-700 dark:text-slate-100">
              Phone Number
            </Label>
            <Input
              id="phoneNumber"
