        ...
        <div className="bg-white border-b border-gray-200">
          <div className="container mx-auto px-4 py-16 text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900">Support Our Mission</h1>
            </div>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <Card className="mb-12">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl">Ways You Can Support</CardTitle>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {supportWays.map((way, index) => {
                  ...
                  return (
                    <div key={index} className={`p-6 rounded-lg border-2 ${way.color}`}>
                      <div className="flex items-start gap-4">
                        <div className="p-2 bg-white rounded-lg">
                          <IconComponent className="h-6 w-6" />
                        </div>
                        <div>
                          <h3 className="font-semibold text-gray-900 mb-2">{way.title}</h3>
            ...
            <Card className="border-2 border-gray-200">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <FaDonate className="text-gray-600" />
                  Donation Information
                </CardTitle>
                <CardDescription>Your financial support helps us maintain and improve the platform</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <h4 className="font-medium text-gray-900">What your donation supports:</h4>
          ...
          <Card className="bg-gray-900 text-white">
            <CardContent className="text-center py-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild variant="secondary" size="lg" className="bg-white text-gray-900 hover:bg-gray-700 hover:text-white">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-gray-600 text-white hover:bg-gray-800 hover:text-gray-100 bg-transparent"
                >
